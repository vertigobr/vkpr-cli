...
setVariablesGHUB() {
  ...
  case $AWS_REGION in
    us-east-1)
    sed -i "/aws_availability_zones/c aws_availability_zones = [\"us-east-1a\",\"us-east-1b\",\"us-east-1c\"]" config/defaults.yml
    ;;
    us-east-2)
    sed -i "/aws_availability_zones/c aws_availability_zones = [\"us-east-2a\",\"us-east-2b\",\"us-east-2c\"]" config/defaults.yml
    ;;
    us-west-1)
    sed -i "/aws_availability_zones/c aws_availability_zones = [\"us-west-1a\",\"us-west-1b\",\"us-west-1c\"]" config/defaults.yml
    ;;
    us-west-2)
    sed -i "/aws_availability_zones/c aws_availability_zones = [\"us-west-2a\",\"us-west-2b\",\"us-west-2c\"]"  config/defaults.yml
    ;;
    af-south-1)
    sed -i "/aws_availability_zones/c aws_availability_zones = [\"af-south-1a\",\"af-south-1b\",\"af-south-1c\"]" config/defaults.yml
    ;;
    ap-east-1)
    sed -i "/aws_availability_zones/c aws_availability_zones = [\"ap-east-1a\",\"ap-east-1b\",\"ap-east-1c\"]"  config/defaults.yml
    ;;
    ap-south-2)
    sed -i "/aws_availability_zones/c aws_availability_zones = [\"ap-south-2a\",\"ap-south-2b\",\"ap-south-2c\"]" config/defaults.yml
    ;;
    ap-southeast-3)
    sed -i "/aws_availability_zones/c aws_availability_zones = [\"ap-southeast-3a\",\"ap-southeast-3b\",\"ap-southeast-3c\"]"  config/defaults.yml
    ;;
    ap-south-1)
    sed -i "/aws_availability_zones/c aws_availability_zones = [\"ap-south-1a\",\"ap-south-1b\",\"ap-south-1c\"]" config/defaults.yml
    ;;
    ap-northeast-3)
    sed -i "/aws_availability_zones/c aws_availability_zones = [\"ap-northeast-3a\",\"ap-northeast-3b\",\"ap-northeast-3c\"]" config/defaults.yml
    ;;
    ap-northeast-2)
    sed -i "/aws_availability_zones/c aws_availability_zones = [\"ap-northeast-2a\",\"ap-northeast-2b\",\"ap-northeast-2c\"]"  config/defaults.yml
    ;;
    ap-northeast-1)
    sed -i "/aws_availability_zones/c aws_availability_zones = [\"ap-northeast-1a\",\"ap-northeast-1b\",\"ap-northeast-1c\"]" config/defaults.yml
    ;;
    ap-southeast-2)
    sed -i "/aws_availability_zones/c aws_availability_zones = [\"ap-southeast-2a\",\"ap-southeast-2b\",\"ap-southeast-2c\"]"  config/defaults.yml
    ;;
    ap-southeast-1)
    sed -i "/aws_availability_zones/c aws_availability_zones = [\"ap-southeast-1a\",\"ap-southeast-1b\",\"ap-southeast-1c\"]"  config/defaults.yml
    ;;
    ca-central-1)
    sed -i "/aws_availability_zones/c aws_availability_zones = [\"ca-central-1a\",\"ca-central-1b\",\"ca-central-1c\"]" config/defaults.yml
    ;;
    eu-central-1)
    sed -i "/aws_availability_zones/c aws_availability_zones = [\"eu-central-1a\",\"eu-central-1b\",\"eu-central-1c\"]" config/defaults.yml
    ;;
    eu-west-1)
    sed -i "/aws_availability_zones/c aws_availability_zones = [\"eu-west-1a\",\"eu-west-1b\",\"eu-west-1c\"]" config/defaults.yml
    ;;
    eu-west-2)
    sed -i "/aws_availability_zones/c aws_availability_zones = [\"eu-west-2a\",\"eu-west-2b\",\"eu-west-2c\"]" config/defaults.yml
    ;;
    eu-south-1)
    sed -i "/aws_availability_zones/c aws_availability_zones = [\"eu-south-1a\",\"eu-south-1b\",\"eu-south-1c\"]" config/defaults.yml
    ;;
    eu-west-3)
    sed -i "/aws_availability_zones/c aws_availability_zones = [\"eu-west-3a\",\"eu-west-3b\",\"eu-west-3c\"]" config/defaults.yml
    ;;
    eu-south-2)
    sed -i "/aws_availability_zones/c aws_availability_zones = [\"eu-south-2a\",\"eu-south-2b\",\"eu-south-2c\"]" config/defaults.yml
    ;;
    eu-north-1)
    sed -i "/aws_availability_zones/c aws_availability_zones = [\"eu-north-1a\",\"eu-north-1b\",\"eu-north-1c\"]" config/defaults.yml
    ;;
    eu-central-2)
    sed -i "/aws_availability_zones/c aws_availability_zones = [\"eu-central-2a\",\"eu-central-2b\",\"eu-central-2c\"]" config/defaults.yml
    ;;
    me-south-1)
    sed -i "/aws_availability_zones/c aws_availability_zones = [\"me-south-1a\",\"me-south-1b\",\"me-south-1c\"]" config/defaults.yml
    ;;
    me-central-1)
    sed -i "/aws_availability_zones/c aws_availability_zones = [\"me-central-1a\",\"me-central-1b\",\"me-central-1c\"]" config/defaults.yml
    ;;
    sa-east-1)
    sed -i "/aws_availability_zones/c aws_availability_zones = [\"sa-east-1a\",\"sa-east-1b\",\"sa-east-1c\"]" config/defaults.yml
    ;;
  esac
